...
`sessions spawned` satırı izlenmesi gereken satırdır: **önbelleğin karşılamadığı her çeviri,
kendi oturumlarının çektiği aynı haftalık kullanım bütçesinden bir `claude` oturumu başlatır.**
Diğer üç satır üzerinden çıkarma yapmaya bırakılmak yerine basılır, çünkü kimsenin türetmediği
bir sayıyı kimse görmez.
