          ...
          '/cli/': [
            {
              ...
              items: [
                ...
                { text: 'atl upgrade', link: '/cli/upgrade' },
                { text: 'atl decided', link: '/cli/decided' },
                ...
                { text: 'atl store', link: '/cli/store' },
                { text: 'atl docs', link: '/cli/docs' },
                { text: 'atl skills', link: '/cli/skills' },
                { text: 'atl rules', link: '/cli/rules' },
                { text: 'atl digest', link: '/cli/digest' },
                { text: 'atl retrieve', link: '/cli/retrieve' },
          ...
          '/tr/cli/': [
            {
              ...
              items: [
                ...
                { text: 'atl upgrade', link: '/tr/cli/upgrade' },
                { text: 'atl decided', link: '/tr/cli/decided' },
                ...
                { text: 'atl store', link: '/tr/cli/store' },
                { text: 'atl docs', link: '/tr/cli/docs' },
                { text: 'atl skills', link: '/tr/cli/skills' },
                { text: 'atl rules', link: '/tr/cli/rules' },
                { text: 'atl digest', link: '/tr/cli/digest' },
                { text: 'atl retrieve', link: '/tr/cli/retrieve' },
