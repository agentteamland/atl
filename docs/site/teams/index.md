...
The rebuild starts with **[profile-team](/teams/profile-team)** — a global, shared user-profile layer that advisory-style teams build on — and **[personal-advisory-team](/teams/personal-advisory-team)**, an honest, wise personal advisor that comes to know you across conversations. Both are now available. This page becomes the full catalog browse page again as more ship.
